...
const fetchNotes = async () => {
  ...
  return (
    <div className='container mx-auto px-4 py-8 mt-6 min-h-screen bg-white'>
        ...
        />
        <button 
            className='fixed bottom-4 right-6 w-14 h-14 bg-blue-700 rounded-full text-white text-3xl shadow-lg hover:bg-blue-800 duration-100 flex items-center justify-center'
